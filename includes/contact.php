...
<section id="contact" class="sec--light">
  <div class="container">
    <div class="sec-head">
      ...
      <a href="https://wa.me/16892968515?text=Hi%20B%26S%20Floor%20Supply%2C%20I'd%20like%20a%20free%20estimate." class="pill" id="cta-wa-pill" target="_blank" rel="noopener" data-i18n="cta_whatsapp_chat">Chat on WhatsApp</a>
    </div>
    <div class="contact">
      <form class="form" id="lead-form-bottom" action="<?=$base?>lead.php" method="POST" aria-labelledby="contact-bottom">
        <div class="row">
          <div>
            ...
            <input id="name-bottom" name="name" placeholder="Your name" data-i18n-placeholder="form_name_placeholder" maxlength="255" required />
          </div>
          <div>
            <label for="phone-bottom" data-i18n="form_phone">Phone / WhatsApp</label>
            <input id="phone-bottom" name="phone" placeholder="+1 (689) 296-8515" data-i18n-placeholder="form_phone_placeholder" maxlength="255" required />
          </div>
        </div>
        <div class="row">
          <div>
            <label for="email-bottom" data-i18n="form_email_label">Email</label>
            <input id="email-bottom" type="email" name="email" placeholder="info@globalservices.com" data-i18n-placeholder="form_email_placeholder" maxlength="255" required />
          </div>
          <div>
        ...
        <div class="row-1">
          <div>
            ...
            <textarea id="message-bottom" name="message" placeholder="Area size, rooms, preferred tone…" data-i18n-placeholder="form_message_placeholder" maxlength="255" required></textarea>
          </div>
        </div>
        ...
        <div class="hero-cta">
          ...
          <a class="btn btn-ghost" href="https://wa.me/16892968515?text=Hi%20B%26S%20Floor%20Supply%2C%20I%20need%20a%20quote." target="_blank" rel="noopener" id="cta-wa-form" data-i18n="cta_whatsapp_now">WhatsApp now</a>
        </div>
      ...
      <aside class="card">
        ...
        <p><strong data-i18n="info_email_label">Email:</strong> <a href="mailto:info@globalservices.com">info@globalservices.com</a></p>
        ...
        <hr />
        <p><small id="info_es" data-i18n-html="info_spanish_note">Prefer español? <em>También atendemos en español.</em></small></p>
      </aside>
    </div>
  </div>
</section>
